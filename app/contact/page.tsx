...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-brand-background">
      ...
      <PageHero
        eyebrow="Контакти"
        title="Нека планираме вашето следващо събитие"
        description="Изпратете запитване и екипът на Събития Колеви ще ви предложи подходящ формат, визия и план за реализация."
      />
      <Section>
        <Container className="grid gap-6 lg:grid-cols-2">
          <Card>
            ...
            <form className="mt-5 space-y-4">
              <input className="w-full rounded-xl border border-brand-accent/30 bg-brand-background p-3" placeholder="Вашето име" />
              <input className="w-full rounded-xl border border-brand-accent/30 bg-brand-background p-3" placeholder="Имейл адрес" />
              <textarea className="min-h-32 w-full rounded-xl border border-brand-accent/30 bg-brand-background p-3" placeholder="С какво можем да помогнем?" />

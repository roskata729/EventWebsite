...
export default async function ServicesPage() {
  ...
  return (
    <main className="min-h-screen bg-brand-background">
      <SiteHeader />
      <PageHero eyebrow="Нашите услуги" title="Цялостни решения за всеки тип събитие" description="Открийте услугите на Събития Колеви, създадени за високо качество, стил и безпроблемна организация." />
      <Section>
